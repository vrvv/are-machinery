...
import com.are.R;
import com.are.adapter.ProductAdapter;
...
public class ProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvRecomMachinery = view.findViewById(R.id.rvRecomMachinery);
        ProductAdapter itemListDataAdapter =
                new ProductAdapter(getActivity());
        rvRecomMachinery.setHasFixedSize(true);
        rvRecomMachinery.setLayoutManager(new LinearLayoutManager(getActivity()));
